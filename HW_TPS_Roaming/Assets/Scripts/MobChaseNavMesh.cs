...
public class MobChaseNavMesh : StateMachineBehaviour
{
    ...
    override public void OnStateEnter(Animator animator, AnimatorStateInfo stateInfo, int layerIndex)
    {
        ...
        roaming = animator.GetComponent<Roaming>();
        roaming.isChasing = true;
    }
    ...
    override public void OnStateExit(Animator animator, AnimatorStateInfo stateInfo, int layerIndex)
    {
        ...
        if (animator.GetCurrentAnimatorStateInfo(0).IsName("Base Layer.Roaming"))
        {
            roaming.isChasing = false;
            roaming.MoveWayPoint();
        }
    }
