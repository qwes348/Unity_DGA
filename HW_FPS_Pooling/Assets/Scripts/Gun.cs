...
public class Gun : MonoBehaviour
{
    ...
    private void MakeShell()
    {
        ...
        pooling.TryGetNextObject(shellEjection.transform.position, Quaternion.identity, out shell);
        StartCoroutine(RemoveShell(shell));        
    }
    ...
    IEnumerator RemoveShell(GameObject shell)
    {
        yield return new WaitForSeconds(1f);
